...
<!--If you want to use the English description, use <p>Given an n-ary tree, return the <i>postorder</i> traversal of its nodes&#39; values.</p>
...
Language: **python**  /  Runtime: 136 ms
