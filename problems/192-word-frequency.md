...
<!--If you want to use the English description, use <p>Write a bash script to calculate the frequency of each word in a text file <code>words.txt</code>.</p>
...
Question: [LeetCode](https://leetcode.com/problems/word-frequency/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/word-frequency/description/)

Solution: [LeetCode](https://leetcode.com/articles/word-frequency/)  /  [LeetCode中国](https://leetcode-cn.com/articles/word-frequency/)