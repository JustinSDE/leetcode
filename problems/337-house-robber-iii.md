...
<!--If you want to use the English description, use <p>The thief has found himself a new place for his thievery again. There is only one entrance to this area, called the &quot;root.&quot; Besides the root, each house has one and only one parent house. After a tour, the smart thief realized that &quot;all houses in this place forms a binary tree&quot;. It will automatically contact the police if two directly-linked houses were broken into on the same night.</p>
...
Question: [LeetCode](https://leetcode.com/problems/house-robber-iii/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/house-robber-iii/description/)

Solution: [LeetCode](https://leetcode.com/articles/house-robber-iii/)  /  [LeetCode中国](https://leetcode-cn.com/articles/house-robber-iii/)