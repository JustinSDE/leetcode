...
<!--If you want to use the English description, use <p>A website domain like &quot;discuss.leetcode.com&quot; consists of various subdomains. At the top level, we have &quot;com&quot;, at the next level, we have &quot;leetcode.com&quot;, and at the lowest level, &quot;discuss.leetcode.com&quot;. When we visit a domain like &quot;discuss.leetcode.com&quot;, we will also visit the parent domains &quot;leetcode.com&quot; and &quot;com&quot; implicitly.</p>
...
class Solution:
    def subdomainVisits(self, cpdomains):
        ...
        for dm in cpdomains:
            times, domain = dm.split()
            times = int(times)
            domain = domain.split('.')
            for i in range(len(domain)):
                domains['.'.join(domain[i:])] += times
        return ['%d %s' % (v, k) for k, v in domains.items()]
...
Question: [LeetCode](https://leetcode.com/problems/subdomain-visit-count/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/subdomain-visit-count/description/)

Solution: [LeetCode](https://leetcode.com/articles/subdomain-visit-count/)  /  [LeetCode中国](https://leetcode-cn.com/articles/subdomain-visit-count/)