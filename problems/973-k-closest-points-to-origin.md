...
<!--If you want to use the English description, use <p>We have a list of <code>points</code>&nbsp;on the plane.&nbsp; Find the <code>K</code> closest points to the origin <code>(0, 0)</code>.</p>
...
Question: [LeetCode](https://leetcode.com/problems/k-closest-points-to-origin/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/k-closest-points-to-origin/description/)

Solution: [LeetCode](https://leetcode.com/articles/k-closest-points-to-origin/)  /  [LeetCode中国](https://leetcode-cn.com/articles/k-closest-points-to-origin/)