...
<!--If you want to use the English description, use <p>Write a function that takes an unsigned integer and return&nbsp;the number of &#39;1&#39;&nbsp;bits it has (also known as the <a href="http://en.wikipedia.org/wiki/Hamming_weight" target="_blank">Hamming weight</a>).</p>
...
Question: [LeetCode](https://leetcode.com/problems/number-of-1-bits/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/number-of-1-bits/description/)

Solution: [LeetCode](https://leetcode.com/articles/number-of-1-bits/)  /  [LeetCode中国](https://leetcode-cn.com/articles/number-of-1-bits/)