...
<!--If you want to use the English description, use <p>You have a list of&nbsp;<code>words</code> and a <code>pattern</code>, and you want to know which words in <code>words</code> matches the pattern.</p>
...
Question: [LeetCode](https://leetcode.com/problems/find-and-replace-pattern/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/find-and-replace-pattern/description/)

Solution: [LeetCode](https://leetcode.com/articles/find-and-replace-pattern/)  /  [LeetCode中国](https://leetcode-cn.com/articles/find-and-replace-pattern/)