...
<!--If you want to use the English description, use <p>Given an input string, reverse the string word by word.</p>
...
<p>For C programmers, try to solve it <em>in-place</em> in <em>O</em>(1) extra space.</p> instead-->
