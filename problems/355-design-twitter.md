...
<!--If you want to use the English description, use <p>Design a simplified version of Twitter where users can post tweets, follow/unfollow another user and is able to see the 10 most recent tweets in the user's news feed. Your design should support the following methods:</p>
...
Question: [LeetCode](https://leetcode.com/problems/design-twitter/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/design-twitter/description/)

Solution: [LeetCode](https://leetcode.com/articles/design-twitter/)  /  [LeetCode中国](https://leetcode-cn.com/articles/design-twitter/)