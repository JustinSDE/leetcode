...
<!--If you want to use the English description, use <p>Given an array, rotate the array to the right by <em>k</em> steps, where&nbsp;<em>k</em>&nbsp;is non-negative.</p>
...
Language: **python3**  /  Runtime: 256 ms
...
Question: [LeetCode](https://leetcode.com/problems/rotate-array/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/rotate-array/description/)

Solution: [LeetCode](https://leetcode.com/articles/rotate-array/)  /  [LeetCode中国](https://leetcode-cn.com/articles/rotate-array/)