...
<!--If you want to use the English description, use <p>Given a nested list of integers, implement an iterator to flatten it.</p>
...
Question: [LeetCode](https://leetcode.com/problems/flatten-nested-list-iterator/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/flatten-nested-list-iterator/description/)

Solution: [LeetCode](https://leetcode.com/articles/flatten-nested-list-iterator/)  /  [LeetCode中国](https://leetcode-cn.com/articles/flatten-nested-list-iterator/)