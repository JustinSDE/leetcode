...
<!--If you want to use the English description, use <p>A zero-indexed array A of length N contains all integers from 0 to N-1. Find and return the longest length of set S, where S[i] = {A[i], A[A[i]], A[A[A[i]]], ... } subjected to the rule below.</p>
...
Question: [LeetCode](https://leetcode.com/problems/array-nesting/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/array-nesting/description/)

Solution: [LeetCode](https://leetcode.com/articles/array-nesting/)  /  [LeetCode中国](https://leetcode-cn.com/articles/array-nesting/)