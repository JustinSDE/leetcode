...
<!--If you want to use the English description, use <p>Write a function to delete a node (except the tail) in a singly linked list, given only access to that node.</p>
