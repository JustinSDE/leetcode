...
<!--If you want to use the English description, use <p>Given an array of citations (each citation is a non-negative integer) of a researcher, write a function to compute the researcher&#39;s h-index.</p>
...
Question: [LeetCode](https://leetcode.com/problems/h-index/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/h-index/description/)

Solution: [LeetCode](https://leetcode.com/articles/h-index/)  /  [LeetCode中国](https://leetcode-cn.com/articles/h-index/)