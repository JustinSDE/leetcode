...
<!--If you want to use the English description, use <p>Given an array of citations <strong>sorted&nbsp;in ascending order </strong>(each citation is a non-negative integer) of a researcher, write a function to compute the researcher&#39;s h-index.</p>
...
Question: [LeetCode](https://leetcode.com/problems/h-index-ii/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/h-index-ii/description/)

Solution: [LeetCode](https://leetcode.com/articles/h-index-ii/)  /  [LeetCode中国](https://leetcode-cn.com/articles/h-index-ii/)