...
<!--If you want to use the English description, use <p>We had some 2-dimensional coordinates, like <code>&quot;(1, 3)&quot;</code> or <code>&quot;(2, 0.5)&quot;</code>.&nbsp; Then, we removed&nbsp;all commas, decimal points, and spaces, and ended up with the string&nbsp;<code>S</code>.&nbsp; Return a list of strings representing&nbsp;all possibilities for what our original coordinates could have been.</p>
...
Question: [LeetCode](https://leetcode.com/problems/ambiguous-coordinates/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/ambiguous-coordinates/description/)

Solution: [LeetCode](https://leetcode.com/articles/ambiguous-coordinates/)  /  [LeetCode中国](https://leetcode-cn.com/articles/ambiguous-coordinates/)