...
<!--If you want to use the English description, use <p>Suppose you have a long flowerbed in which some of the plots are planted and some are not. However, flowers cannot be planted in adjacent plots - they would compete for water and both would die.</p>
...
Question: [LeetCode](https://leetcode.com/problems/can-place-flowers/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/can-place-flowers/description/)

Solution: [LeetCode](https://leetcode.com/articles/can-place-flowers/)  /  [LeetCode中国](https://leetcode-cn.com/articles/can-place-flowers/)