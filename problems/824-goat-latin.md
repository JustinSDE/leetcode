...
<!--If you want to use the English description, use <p>A sentence <code>S</code> is given, composed of words separated by spaces. Each word consists of lowercase and uppercase letters only.</p>
...
Question: [LeetCode](https://leetcode.com/problems/goat-latin/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/goat-latin/description/)

Solution: [LeetCode](https://leetcode.com/articles/goat-latin/)  /  [LeetCode中国](https://leetcode-cn.com/articles/goat-latin/)