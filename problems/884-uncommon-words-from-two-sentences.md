...
<!--If you want to use the English description, use <p>We are given two sentences <code>A</code> and <code>B</code>.&nbsp; (A <em>sentence</em>&nbsp;is a string of space separated words.&nbsp; Each <em>word</em> consists only of lowercase letters.)</p>
...
Question: [LeetCode](https://leetcode.com/problems/uncommon-words-from-two-sentences/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/uncommon-words-from-two-sentences/description/)

Solution: [LeetCode](https://leetcode.com/articles/uncommon-words-from-two-sentences/)  /  [LeetCode中国](https://leetcode-cn.com/articles/uncommon-words-from-two-sentences/)