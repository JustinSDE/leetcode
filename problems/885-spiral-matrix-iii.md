...
<!--If you want to use the English description, use <p>On a 2 dimensional grid with <code>R</code> rows and <code>C</code> columns, we start at <code>(r0, c0)</code> facing east.</p>
...
Question: [LeetCode](https://leetcode.com/problems/spiral-matrix-iii/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/spiral-matrix-iii/description/)

Solution: [LeetCode](https://leetcode.com/articles/spiral-matrix-iii/)  /  [LeetCode中国](https://leetcode-cn.com/articles/spiral-matrix-iii/)