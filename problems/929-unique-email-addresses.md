...
<!--If you want to use the English description, use <p>Every email consists of a local name and a domain name, separated by the @ sign.</p>
...
Question: [LeetCode](https://leetcode.com/problems/unique-email-addresses/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/unique-email-addresses/description/)

Solution: [LeetCode](https://leetcode.com/articles/unique-email-addresses/)  /  [LeetCode中国](https://leetcode-cn.com/articles/unique-email-addresses/)