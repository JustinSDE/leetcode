...
<!--If you want to use the English description, use <p>A matrix is <em>Toeplitz</em> if every diagonal from top-left to bottom-right has the same element.</p>
...
Question: [LeetCode](https://leetcode.com/problems/toeplitz-matrix/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/toeplitz-matrix/description/)

Solution: [LeetCode](https://leetcode.com/articles/toeplitz-matrix/)  /  [LeetCode中国](https://leetcode-cn.com/articles/toeplitz-matrix/)