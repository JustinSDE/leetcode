...
<!--If you want to use the English description, use <p>On a broken calculator that has a number showing on its display, we can perform two operations:</p>
...
Question: [LeetCode](https://leetcode.com/problems/broken-calculator/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/broken-calculator/description/)

Solution: [LeetCode](https://leetcode.com/articles/broken-calculator/)  /  [LeetCode中国](https://leetcode-cn.com/articles/broken-calculator/)