...
<!--If you want to use the English description, use <p>International Morse Code defines a standard encoding where each letter is mapped to a series of dots and dashes, as follows: <code>&quot;a&quot;</code> maps to <code>&quot;.-&quot;</code>, <code>&quot;b&quot;</code> maps to <code>&quot;-...&quot;</code>, <code>&quot;c&quot;</code> maps to <code>&quot;-.-.&quot;</code>, and so on.</p>
...
class Solution:
    def uniqueMorseRepresentations(self, words):
        ...
        """
        mcs = [".-","-...","-.-.","-..",".","..-.","--.","....","..",".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...","-","..-","...-",".--","-..-","-.--","--.."]
        d = {string.ascii_lowercase[i]: mc for i, mc in enumerate(mcs)}
        return len(set([''.join(map(lambda c: d[c], w)) for w in words]))
...
Question: [LeetCode](https://leetcode.com/problems/unique-morse-code-words/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/unique-morse-code-words/description/)

Solution: [LeetCode](https://leetcode.com/articles/unique-morse-code-words/)  /  [LeetCode中国](https://leetcode-cn.com/articles/unique-morse-code-words/)