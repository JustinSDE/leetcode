...
<!--If you want to use the English description, use <p>Given an array <em>nums</em> and a value <em>val</em>, remove all instances of that value <a href="https://en.wikipedia.org/wiki/In-place_algorithm" target="_blank"><strong>in-place</strong></a> and return the new length.</p>
...
Question: [LeetCode](https://leetcode.com/problems/remove-element/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/remove-element/description/)

Solution: [LeetCode](https://leetcode.com/articles/remove-element/)  /  [LeetCode中国](https://leetcode-cn.com/articles/remove-element/)