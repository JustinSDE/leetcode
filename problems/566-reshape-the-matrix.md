...
<!--If you want to use the English description, use <p>In MATLAB, there is a very useful function called 'reshape', which can reshape a matrix into a new one with different size but keep its original data.
</p>
...
Question: [LeetCode](https://leetcode.com/problems/reshape-the-matrix/description/)  /  [LeetCode中国](https://leetcode-cn.com/problems/reshape-the-matrix/description/)

Solution: [LeetCode](https://leetcode.com/articles/reshape-the-matrix/)  /  [LeetCode中国](https://leetcode-cn.com/articles/reshape-the-matrix/)